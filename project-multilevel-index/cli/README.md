...
- 🔍 **Multi-language code analysis** - Supports 10+ programming languages
- 📝 **Auto-generated file headers** - Input/Output/Position comments
- 📁 **Folder indexes** - FOLDER_INDEX.md for each directory
- 📊 **Project index** - PROJECT_INDEX.md with dependency graph
- 🔄 **Self-referential** - Documents that maintain themselves
...
├── src/
│   ├── core/
│   │   ├── analyzer.ts      # Multi-language code analysis
│   │   └── generator.ts     # Header and index generation
│   ├── commands/
