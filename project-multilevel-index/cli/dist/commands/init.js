...
export async function initCommand(options = {}) {
    ...
    try {
        ...
        const dependencyGraph = await generator.generateDependencyGraph(analyses, options.maxNodes || 50);
        const projectIndex = await generator.generateProjectIndex(rootPath, folderStructure, dependencyGraph);
